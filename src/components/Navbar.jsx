...
const Navbar = () => {
  ...
  // 'scroll' olay dinleyicisini ekliyoruz
  // Bu olay dinleyicisi, tarayıcı penceresi kaydırıldığında onNavScroll işlevini çağırır.ayrıca bellek kullanımını azaltır.
  return (
    <>
      <header className={
      ...
      >
        <nav className="flex items-center justify-between nike-container">
          <div className="flex items-center">
            ...
            />
            {/*bir koşulun sağlanıp sağlanmadığına bakmak için kullanılır*/}
          </div>
